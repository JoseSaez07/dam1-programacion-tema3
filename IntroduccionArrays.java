...
public class IntroduccionArrays {
    ...
    public static void main(String[] args) {
        ...
        // 2. Crear una instancia de la clase para llamar al método no estático
        IntroduccionArrays ejemplo = new IntroduccionArrays();

        // 3. Llama al método mostrarTemperaturas
        ejemplo.mostrarTemperaturas(maxTemperaturas);
    }
}